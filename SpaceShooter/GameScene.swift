...
//  SpaceShooter
//
//  Created by Кирилл Суворов on 21.07.2023.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        starfield.position = CGPoint(x: UIScreen.main.bounds.width / 2, y: 1472)
        ...
        var timelnterval = 0.75
        
        if UserDefaults.standard.bool(forKey: "Hard"){
            timelnterval = 0.3
        }
        
        gameTimer = Timer.scheduledTimer(timeInterval: timelnterval, target: self, selector: #selector(addAlien), userInfo: nil, repeats: true)
